...
export class UserComponent extends BaseItemComponent implements OnInit {
  ...
  private getBranches() {
    ...
    this.branchSer.getBranchListBySearchObject(branchSearchObj).subscribe((data: any) => {
  ...
  private getAuthorities() {
    this.authoritySer.getAllAuthorities().subscribe((data: any) => {
